...
[![Development](https://go-skill-icons.vercel.app/api/icons?i=typescript,tailwind,react,nextjs,nestjs,laravel,prisma,postgres,java,python,electron)](https://skillicons.dev)

### DevOps

[![DevOps](https://go-skill-icons.vercel.app/api/icons?i=linux,bash,powershell,docker,kubernetes,terraform,ansible,githubactions,aws,azure,gcp,nginx,prometheus,grafana)](https://skillicons.dev)

### Learning

[![Learning](https://go-skill-icons.vercel.app/api/icons?i=rust,tauri,godot,wasm,vue,nuxt)](https://skillicons.dev)
